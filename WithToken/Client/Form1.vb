...
Public Class Form1
    ...
    Private Sub TambahData()
        ...
        Dim mytoken As String = Token

        Dim postData As String = $"nim={nim}&nama={nama}&jk={jk}&prodi={prodi}&token={mytoken}"
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(mahasiswa_api & "?nim=" & txtNIM.Text & "&token=" & Token, "DELETE", byteArray)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(mahasiswa_api & "?nim=" & txtNIM.Text & "&token=" & Token).Result
    ...
    Private Sub Reloaded()
        ...
        Dim response As String = client.DownloadString(mahasiswa_api & "?token=" & Token)
